...
## P 和 M 的个数[#](read://https_learnku.com/?url=https%3A%2F%2Flearnku.com%2Farticles%2F86574#b987d8)
...
## goroutine 内存泄漏原因和处理[#](read://https_learnku.com/?url=https%3A%2F%2Flearnku.com%2Farticles%2F86574#5c750c)
...
## Go 语言中的 select 语句是什么？请给出一个使用 select 语句的示例？[#](read://https_learnku.com/?url=https%3A%2F%2Flearnku.com%2Farticles%2F86574#60a98a)
...
并发安全性是指在并发编程中，多个 goroutine 对共享资源的访问不会导致数据竞争和不确定的结果。为了确保并发安全性，可以采取以下措施：
...
## 如何实现 map 线程安全[#](read://https_learnku.com/?url=https%3A%2F%2Flearnku.com%2Farticles%2F86574#81e0e5)
...
## Redis 的雪崩、穿透和击穿，如何应对？[#](read://https_learnku.com/?url=https%3A%2F%2Flearnku.com%2Farticles%2F86574#92bff0)
...
## redis 如何实现延迟队列？[#](read://https_learnku.com/?url=https%3A%2F%2Flearnku.com%2Farticles%2F86574#57ee79)
...
## 并发事务的控制方式有哪些？[#](read://https_learnku.com/?url=https%3A%2F%2Flearnku.com%2Farticles%2F86574#1f2d3e)
...
## mysql 索引数据结构？[#](read://https_learnku.com/?url=https%3A%2F%2Flearnku.com%2Farticles%2F86574#5247bc)
...
## 当在浏览器上输入一个网址，其内部发生了什么？[#](read://https_learnku.com/?url=https%3A%2F%2Flearnku.com%2Farticles%2F86574#53e8f4)
...
## Tcp 为什么 3 次握手？[#](read://https_learnku.com/?url=https%3A%2F%2Flearnku.com%2Farticles%2F86574#68ddbe)
...
## 为什么要四次挥手？[#](read://https_learnku.com/?url=https%3A%2F%2Flearnku.com%2Farticles%2F86574#5ba3bb)
...
## 常用的网络攻击手段有哪些？[#](read://https_learnku.com/?url=https%3A%2F%2Flearnku.com%2Farticles%2F86574#9a5bc9)
...
## 数据结构[#](read://https_learnku.com/?url=https%3A%2F%2Flearnku.com%2Farticles%2F86574#0fea7c)
...
# PHP 相关[#](read://https_learnku.com/?url=https%3A%2F%2Flearnku.com%2Farticles%2F86574#2b1b13)

## 什么是 fastcgi?[#](read://https_learnku.com/?url=https%3A%2F%2Flearnku.com%2Farticles%2F86574#60a4b5)

FastCGI 进程管理器自身初始化，包括 master 和 worker 进程两部分，master 进程监听端口，接收来自 Web Server 请求，worker 进程一般具有多个，每个 worker 进程都有一个 cgi 进程解释器，用来执行 php 代码，等待来自 Web Server 的连接。 2. 当客户端请求到达 Web Server 时，FastCGI 进程管理器选择并连接到一个 CGI 解释器。Web Server 将 CGI 环境变量和标准输入发送到 FastCGI 子进程 php-cgi 3.FastCGI 子进程完成处理后将标准输出和错误信息从同一连接返回 Web Server。当 FastCGI 子进程关闭连接时，请求便告知处理完成。FastCGI 子进程接着等待并处理来自 FastCGI 继承管理器的下一个连接。

## php-fpm 讲一下？[#](read://https_learnku.com/?url=https%3A%2F%2Flearnku.com%2Farticles%2F86574#d7227e)
...
## php-fpm 如何优化：[#](read://https_learnku.com/?url=https%3A%2F%2Flearnku.com%2Farticles%2F86574#ebc671)
...
### 常见异常[#](read://https_learnku.com/?url=https%3A%2F%2Flearnku.com%2Farticles%2F86574#3f8b9e)

- 502 错误 502 Bad Gateway 在 php.ini 和 php-fpm.conf 中分别有这样两个配置项：max_execution_time 和 request_terminate_timeout。 这两项都是用来配置一个 PHP 脚本的最大执行时间的。当超过这个时间时，PHP-FPM 不只会终止脚本的执行，还会终止执行脚本的 Worker 进程。所以 Nginx 会发现与自己通信的连接断掉了，就会返回给客户端 502 错误。
- 504 错误 504 Gateway Time-out 由于程序执行时间过长导致响应超时，例如程序需要执行 90 秒，而 nginx 最大响应等待时间为 30 秒，这样就会出现超时。

PHP-FPM 设置的脚本最大执行时间已经够长了，但执行耗时 PHP 脚本时，发现 Nginx 报错从 502 变为 504 了。这是为什么呢？
...
## php7 和 php5 区别[#](read://https_learnku.com/?url=https%3A%2F%2Flearnku.com%2Farticles%2F86574#9135a2)
...
## 为什么 php7 比 php5 性能提升了 2 倍呢？[#](read://https_learnku.com/?url=https%3A%2F%2Flearnku.com%2Farticles%2F86574#46cd56)

1. 变量存储字节减少，减少内存占用，替身变量操作速度；
2. 改善数组结构，数组元素和 hash 映射表被分配在同一块内存里，降低内存占用，提升了 cpu 缓存命中率
3. 改进函数的调用机制，通过优化参数传递的环节，减少了一些指令，提高执行效率；

# 算法相关[#](read://https_learnku.com/?url=https%3A%2F%2Flearnku.com%2Farticles%2F86574#0d2089)
